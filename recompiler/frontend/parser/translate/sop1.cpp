  ...
  *pCode += 1;
  ...
  switch (op) {
    case eOpcode::S_MOV_B32: {
      ir.moveOp(sdst, src0, ir::OperandType::i32());
    } break;
    case eOpcode::S_MOV_B64: {
      ir.moveOp(sdst, src0, ir::OperandType::i64());
    } break;
    case eOpcode::S_CMOV_B32: {
      ir.selectOp(sdst, OpSrc(eOperandKind::SCC()), src0, OpSrc(eOperandKind::SCC()), ir::OperandType::i32());
    } break;
    case eOpcode::S_CMOV_B64: {
      ir.selectOp(sdst, OpSrc(eOperandKind::SCC()), src0, OpSrc(eOperandKind::SCC()), ir::OperandType::i64());
    } break;
    case eOpcode::S_NOT_B32: {
      ir.moveOp(sdst, OpSrc(src0.kind, true, false), ir::OperandType::i32());
      ir.cmpIOp(OpDst(eOperandKind::SCC()), OpSrc(sdst.kind), OpSrc(eOperandKind::createImm(0)), ir::OperandType::i32(), CmpIPredicate::ne);
    } break;
    case eOpcode::S_NOT_B64: {
      ir.moveOp(sdst, OpSrc(src0.kind, true, false), ir::OperandType::i64());
      ir.cmpIOp(OpDst(eOperandKind::SCC()), OpSrc(sdst.kind), OpSrc(eOperandKind::createImm(0)), ir::OperandType::i64(), CmpIPredicate::ne);
    } break;
    ...
    case eOpcode::S_BREV_B32: {
      ir.bitReverseOp(sdst, src0, ir::OperandType::i32());
    } break;
    case eOpcode::S_BREV_B64: {
      ir.bitReverseOp(sdst, src0, ir::OperandType::i64());
    } break;
    case eOpcode::S_BCNT0_I32_B32: {
      ir.bitCountOp(sdst, OpSrc(src0.kind, true, false), ir::OperandType::i32());
      ir.cmpIOp(OpDst(eOperandKind::SCC()), OpSrc(sdst.kind), OpSrc(eOperandKind::createImm(0)), ir::OperandType::i32(), CmpIPredicate::ne);
    } break;
    case eOpcode::S_BCNT0_I32_B64: {
      ir.bitCountOp(sdst, OpSrc(src0.kind, true, false), ir::OperandType::i64());
      ir.cmpIOp(OpDst(eOperandKind::SCC()), OpSrc(sdst.kind), OpSrc(eOperandKind::createImm(0)), ir::OperandType::i32(), CmpIPredicate::ne);
    } break;
    case eOpcode::S_BCNT1_I32_B32: {
      ir.bitCountOp(sdst, src0, ir::OperandType::i32());
      ir.cmpIOp(OpDst(eOperandKind::SCC()), OpSrc(sdst.kind), OpSrc(eOperandKind::createImm(0)), ir::OperandType::i32(), CmpIPredicate::ne);
    } break;
    case eOpcode::S_BCNT1_I32_B64: {
      ir.bitCountOp(sdst, src0, ir::OperandType::i64());
      ir.cmpIOp(OpDst(eOperandKind::SCC()), OpSrc(sdst.kind), OpSrc(eOperandKind::createImm(0)), ir::OperandType::i32(), CmpIPredicate::ne);
    } break;
    case eOpcode::S_FF0_I32_B32: {
      ir.findILsbOp(sdst, OpSrc(src0.kind, true, false), ir::OperandType::i32());
    } break;
    case eOpcode::S_FF0_I32_B64: {
      ir.findILsbOp(sdst, OpSrc(src0.kind, true, false), ir::OperandType::i64());
    } break;
    case eOpcode::S_FF1_I32_B32: {
      ir.findILsbOp(sdst, src0, ir::OperandType::i32());
    } break;
    case eOpcode::S_FF1_I32_B64: {
      ir.findILsbOp(sdst, src0, ir::OperandType::i64());
    } break;
    case eOpcode::S_FLBIT_I32_B32: {
      ir.findUMsbOp(sdst, src0, ir::OperandType::i32());
    } break;
    case eOpcode::S_FLBIT_I32_B64: {
      ir.findUMsbOp(sdst, src0, ir::OperandType::i64());
    } break;
    case eOpcode::S_FLBIT_I32: {
      ir.findSMsbOp(sdst, src0, ir::OperandType::i32());
    } break;
    case eOpcode::S_FLBIT_I32_I64: {
      ir.findSMsbOp(sdst, src0, ir::OperandType::i64());
    } break;
    case eOpcode::S_SEXT_I32_I8: {
      ir.signExtendI32Op(sdst, src0, ir::OperandType::i8());
    } break;
    case eOpcode::S_SEXT_I32_I16: {
      ir.signExtendI32Op(sdst, src0, ir::OperandType::i16());
    } break;
    case eOpcode::S_BITSET0_B32: {
      ir.bitsetOp(sdst, OpSrc(sdst.kind), src0, OpSrc(eOperandKind::createImm(0)), ir::OperandType::i32());
    } break;
    case eOpcode::S_BITSET0_B64: {
      ir.bitsetOp(sdst, OpSrc(sdst.kind), src0, OpSrc(eOperandKind::createImm(0)), ir::OperandType::i64());
    } break;
    case eOpcode::S_BITSET1_B32: {
      ir.bitsetOp(sdst, OpSrc(sdst.kind), src0, OpSrc(OpSrc(eOperandKind::createImm(1))), ir::OperandType::i32());
    } break;
    case eOpcode::S_BITSET1_B64: {
      ir.bitsetOp(sdst, OpSrc(sdst.kind), src0, OpSrc(OpSrc(eOperandKind::createImm(1))), ir::OperandType::i64());
    } break;
    case eOpcode::S_GETPC_B64: {
      ir.constantOp(sdst, ir::ConstantValue {.value_u64 = 4 + pc}, ir::OperandType::i64());
    } break;
    case eOpcode::S_SETPC_B64: {
      ir.jumpAbsOp(src0);
    } break;
    case eOpcode::S_SWAPPC_B64: {
      ir.constantOp(sdst, ir::ConstantValue {.value_u64 = 4 + pc}, ir::OperandType::i64()); // Save current pc
    ...
    case eOpcode::S_AND_SAVEEXEC_B64: {
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
      ir.bitAndOp(OpDst(eOperandKind::EXEC()), src0, OpSrc(sdst.kind), ir::OperandType::i1());
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
    } break;
    case eOpcode::S_OR_SAVEEXEC_B64: {
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
      ir.bitOrOp(OpDst(eOperandKind::EXEC()), src0, OpSrc(sdst.kind), ir::OperandType::i1());
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
    } break;
    case eOpcode::S_XOR_SAVEEXEC_B64: {
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
      ir.bitXorOp(OpDst(eOperandKind::EXEC()), src0, OpSrc(sdst.kind), ir::OperandType::i1());
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
    } break;
    case eOpcode::S_ANDN2_SAVEEXEC_B64: {
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
      ir.bitAndOp(OpDst(eOperandKind::EXEC()), src0, OpSrc(sdst.kind, true, false), ir::OperandType::i1());
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
    } break;
    case eOpcode::S_ORN2_SAVEEXEC_B64: {
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
      ir.bitOrOp(OpDst(eOperandKind::EXEC()), src0, OpSrc(sdst.kind, true, false), ir::OperandType::i1());
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
    } break;
    case eOpcode::S_NAND_SAVEEXEC_B64: {
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
      ir.bitAndOp(OpDst(eOperandKind::EXEC(), 0, false, true), src0, OpSrc(sdst.kind), ir::OperandType::i1());
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
    } break;
    case eOpcode::S_NOR_SAVEEXEC_B64: {
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
      ir.bitOrOp(OpDst(eOperandKind::EXEC(), 0, false, true), src0, OpSrc(sdst.kind), ir::OperandType::i1());
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
    } break;
    case eOpcode::S_XNOR_SAVEEXEC_B64: {
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
      ir.bitXorOp(OpDst(eOperandKind::EXEC(), 0, false, true), src0, OpSrc(sdst.kind), ir::OperandType::i1());
      ir.moveOp(sdst, OpSrc(eOperandKind::EXEC()), ir::OperandType::i1());
    } break;
    ...
    case eOpcode::S_ABS_I32: {
      ir.moveOp(sdst, OpSrc(src0.kind, false, true), ir::OperandType::i32());
    } break;
