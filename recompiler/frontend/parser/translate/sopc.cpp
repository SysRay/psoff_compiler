  ...
  *pCode += 1;
  ...
  switch (op) {
    case eOpcode::S_CMP_EQ_I32: {
      builder.createInstruction(create::cmpIOp(OpDst(eOperandKind::Scc), OpSrc(src0), OpSrc(src1), ir::OperandType::i32(), CmpIPredicate::eq));
    } break;
    case eOpcode::S_CMP_LG_I32: {
      builder.createInstruction(create::cmpIOp(OpDst(eOperandKind::Scc), OpSrc(src0), OpSrc(src1), ir::OperandType::i32(), CmpIPredicate::ne));
    } break;
    ...
    case eOpcode::S_CMP_GE_I32: {
      builder.createInstruction(create::cmpIOp(OpDst(eOperandKind::Scc), OpSrc(src0), OpSrc(src1), ir::OperandType::i32(), CmpIPredicate::sge));
    } break;
    ...
    case eOpcode::S_CMP_LE_I32: {
      builder.createInstruction(create::cmpIOp(OpDst(eOperandKind::Scc), OpSrc(src0), OpSrc(src1), ir::OperandType::i32(), CmpIPredicate::sle));
    } break;
    ...
    case eOpcode::S_CMP_GE_U32: {
      builder.createInstruction(create::cmpIOp(OpDst(eOperandKind::Scc), OpSrc(src0), OpSrc(src1), ir::OperandType::i32(), CmpIPredicate::uge));
    } break;
    ...
    case eOpcode::S_CMP_LE_U32: {
      builder.createInstruction(create::cmpIOp(OpDst(eOperandKind::Scc), OpSrc(src0), OpSrc(src1), ir::OperandType::i32(), CmpIPredicate::ule));
    } break;
    case eOpcode::S_BITCMP0_B32: {
      builder.createInstruction(create::bitCmpOp(OpDst(eOperandKind::Scc), OpSrc(src0, true, false), ir::OperandType::i32(), OpSrc(src1)));
    } break;
    case eOpcode::S_BITCMP1_B32: {
      builder.createInstruction(create::bitCmpOp(OpDst(eOperandKind::Scc), OpSrc(src0), ir::OperandType::i32(), OpSrc(src1)));
    } break;
    case eOpcode::S_BITCMP0_B64: {
      builder.createInstruction(create::bitCmpOp(OpDst(eOperandKind::Scc), OpSrc(src0, true, false), ir::OperandType::i64(), OpSrc(src1)));
    } break;
    case eOpcode::S_BITCMP1_B64: {
      builder.createInstruction(create::bitCmpOp(OpDst(eOperandKind::Scc), OpSrc(src0), ir::OperandType::i64(), OpSrc(src1)));
    } break;
    case eOpcode::S_SETVSKIP: {
      builder.createInstruction(create::bitCmpOp(OpDst(eOperandKind::CustomVskip), OpSrc(src0), ir::OperandType::i32(), OpSrc(src1)));
    } break;
