...
void ShaderVertexData::init(ShaderInput& ctx, ShaderHeader const* header, uint32_t const* gpuRegs) {
  ...
  ctx.totalSGPR = getTotalSgprs<SPI_SHADER_PGM_RSRC1_VS, mmSPI_SHADER_PGM_RSRC1_VS>(gpuRegs);
  ctx.totalVGPR = getTotalVgprs<SPI_SHADER_PGM_RSRC1_VS, mmSPI_SHADER_PGM_RSRC1_VS>(gpuRegs);

  ctx.userSGPRSize     = getTotalUserSgprs<SPI_SHADER_PGM_RSRC2_VS, mmSPI_SHADER_PGM_RSRC2_VS>(gpuRegs);
  auto const* userData = &gpuRegs[mmSPI_SHADER_USER_DATA_VS_0];
  for (uint8_t n = 0; n < ctx.userSGPRSize; ++n) {
    ctx.userSGPR[n] = userData[n];
  }

  auto const reg = SPI_SHADER_PGM_RSRC1_VS(gpuRegs[mmSPI_SHADER_PGM_RSRC1_VS]);
  numComponents  = reg.template get<SPI_SHADER_PGM_RSRC1_VS::Field::VGPR_COMP_CNT>();
...
void ShaderVertexExportData::init(ShaderInput& ctx, ShaderHeader const* header, uint32_t const* gpuRegs) {
  ...
  ctx.totalSGPR = getTotalSgprs<SPI_SHADER_PGM_RSRC1_ES, mmSPI_SHADER_PGM_RSRC1_ES>(gpuRegs);
  ctx.totalVGPR = getTotalVgprs<SPI_SHADER_PGM_RSRC1_ES, mmSPI_SHADER_PGM_RSRC1_ES>(gpuRegs);

  ctx.userSGPRSize     = getTotalUserSgprs<SPI_SHADER_PGM_RSRC2_ES, mmSPI_SHADER_PGM_RSRC2_ES>(gpuRegs);
...
void ShaderVertexLocalData::init(ShaderInput& ctx, ShaderHeader const* header, uint32_t const* gpuRegs) {
  ...
  ctx.totalSGPR = getTotalSgprs<SPI_SHADER_PGM_RSRC1_LS, mmSPI_SHADER_PGM_RSRC1_LS>(gpuRegs);
  ctx.totalVGPR = getTotalVgprs<SPI_SHADER_PGM_RSRC1_LS, mmSPI_SHADER_PGM_RSRC1_LS>(gpuRegs);

  ctx.userSGPRSize     = getTotalUserSgprs<SPI_SHADER_PGM_RSRC2_LS, mmSPI_SHADER_PGM_RSRC2_LS>(gpuRegs);
...
void ShaderFragmentData::init(ShaderInput& ctx, ShaderHeader const* header, uint32_t const* gpuRegs) {
  ...
  ctx.totalSGPR = getTotalSgprs<SPI_SHADER_PGM_RSRC1_PS, mmSPI_SHADER_PGM_RSRC1_PS>(gpuRegs);
  ctx.totalVGPR = getTotalVgprs<SPI_SHADER_PGM_RSRC1_PS, mmSPI_SHADER_PGM_RSRC1_PS>(gpuRegs);

  ctx.userSGPRSize     = getTotalUserSgprs<SPI_SHADER_PGM_RSRC2_PS, mmSPI_SHADER_PGM_RSRC2_PS>(gpuRegs);
...
void ShaderComputeData::init(ShaderInput& ctx, ShaderHeader const* header, uint32_t const* gpuRegs) {
  ...
  ctx.totalSGPR = getTotalSgprs<COMPUTE_PGM_RSRC1, mmCOMPUTE_PGM_RSRC1>(gpuRegs);
  ctx.totalVGPR = getTotalVgprs<COMPUTE_PGM_RSRC1, mmCOMPUTE_PGM_RSRC1>(gpuRegs);

  ctx.userSGPRSize     = getTotalUserSgprs<COMPUTE_PGM_RSRC2, mmCOMPUTE_PGM_RSRC2>(gpuRegs);
...
void ShaderGeometryData::init(ShaderInput& ctx, ShaderHeader const* header, uint32_t const* gpuRegs) {
  ...
  ctx.totalSGPR = getTotalSgprs<SPI_SHADER_PGM_RSRC1_GS, mmSPI_SHADER_PGM_RSRC1_GS>(gpuRegs);
  ctx.totalVGPR = getTotalVgprs<SPI_SHADER_PGM_RSRC1_GS, mmSPI_SHADER_PGM_RSRC1_GS>(gpuRegs);

  ctx.userSGPRSize     = getTotalUserSgprs<SPI_SHADER_PGM_RSRC2_GS, mmSPI_SHADER_PGM_RSRC2_GS>(gpuRegs);
...
void ShaderTessCntrlData::init(ShaderInput& ctx, ShaderHeader const* header, uint32_t const* gpuRegs) {
  ...
  ctx.totalSGPR = getTotalSgprs<SPI_SHADER_PGM_RSRC1_HS, mmSPI_SHADER_PGM_RSRC1_HS>(gpuRegs);
  ctx.totalVGPR = getTotalVgprs<SPI_SHADER_PGM_RSRC1_HS, mmSPI_SHADER_PGM_RSRC1_HS>(gpuRegs);

  ctx.userSGPRSize     = getTotalUserSgprs<SPI_SHADER_PGM_RSRC2_HS, mmSPI_SHADER_PGM_RSRC2_HS>(gpuRegs);
